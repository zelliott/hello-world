var showCommittees = function (el, d) {
    var $el = $(el);
    $el.empty();
...
function dashboard(id, fData){
    ...
    (d3.entries(fData)).forEach(function(d){d.total=d.value["count_cosponsored"];});
...
//    console.log(tF);
    ...
    var sF = (d3.entries(fData)).map(function(d){return [d.key, d.value["count_cosponsored"]];});
